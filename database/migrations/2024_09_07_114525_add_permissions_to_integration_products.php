...
return new class extends Migration
{
    ...
    */
    ...
    {
        $this->guardName = "crafter";

        $permissions = collect(["crafter.integration-product.index","crafter.integration-product.create","crafter.integration-product.edit","crafter.integration-product.destroy"]);
