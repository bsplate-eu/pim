...
namespace App\Translations\Service;

use App\Translations\Import\TranslationsImport;
...
class TranslationService
{
    ...
    public function getCollectionFromImportedFile($file, $chosenLanguage)
    {
        if ($file->getClientOriginalExtension() !== 'xlsx') {
            abort(409, ___('crafter', 'Unsupported file type'));
        }
        ...
        if (! $this->validImportFile($collectionFromImportedFile, $chosenLanguage)) {
            abort(409, ___('crafter', 'Wrong syntax in your import'));
        }
