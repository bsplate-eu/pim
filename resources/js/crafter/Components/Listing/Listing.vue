              ...
              <tr
                ...
                :class="[
                  ...
                  selectedItems.includes(item.id)
                    ? (striped ? '!bg-primary-50' : 'bg-gray-50')
                    : '',
                ]"
              >
                <ListingDataCell
...
import { Model } from "crafter/types/models";
import { useBulkSelect } from "crafter/hooks/useBulkSelect";
import { useBulkAction } from "crafter/hooks/useBulkAction";
import { useAction } from "crafter/hooks/useAction";
import { useListingSearch } from "crafter/hooks/useListingSearch";
