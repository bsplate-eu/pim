    ...
    >
      ...
      >
        ...
        <template #singlelabel="{ value }">
          <div class="multiselect-single-label text-gray-800 text-sm">
...
import { useInput } from "crafter/hooks/useInput";
import { Tag, FormControl } from "./index";
...
const multiselectStyles = {
  container: `mx-auto w-full flex items-center justify-end box-border cursor-pointer rounded-md bg-white text-base leading-none outline-none py-0 min-h-[36px] ${
  ...
  placeholder:
    "flex items-center h-full absolute left-0 top-0 pointer-events-none bg-transparent leading-snug pl-3 text-gray-600 text-sm",
  caret:
