<template>
  <Modal :open="open" @toggle-open="toggleOpen" :external-open="true">
    <template #title>
      {{ $t("crafter", "Import translations") }}</template
    >
    <template #content>
...
import { Button, Modal } from "crafter/Components";
import { onMounted, ref } from "vue";
import ImportModalFirstStep from "crafter/Pages/Translations/Components/ImportModalFirstStep.vue";
import ImportModalThirdStep from "crafter/Pages/Translations/Components/ImportModalThirdStep.vue";
import ImportModalSecondStep from "crafter/Pages/Translations/Components/ImportModalSecondStep.vue";
...
const nextStep = () => {
  ...
  if (currentStep.value === 1) {
    let url = route("crafter.translations.import");
    ...
    axios
      ...
      .then(
        ...
        (error) => {
          toast.error(trans("crafter", "An error has occurred."));
        }
      )
      .finally(() => {
        processing.value = false;
